...
function Navigation() {
  ...
  const handleSearchSubmit = (event) => {
    ...
    if (searchQuery.trim()) {
      // Navigate to the search page with query in the URL, including page and sort params
      navigate(
        `/search-watches?query=${searchQuery}&page=1&limit=10&sort=name_asc`
      );
    }
  };
...
//       navigate(`/search-watches?query=${searchQuery}`);
//     }
//   };
